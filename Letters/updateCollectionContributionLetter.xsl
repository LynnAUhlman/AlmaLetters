        ...
        <div class="messageArea">
            <div class="messageBody">
					 ...
					 <table role='presentation' cellspacing="0" cellpadding="5" border="0">
						...
						<xsl:if test="/notification_data/detached_bib  !=''">
							<tr><td>
							<br /><xsl:value-of select="/notification_data/detached_bib" /><a>&#160;@@detachedBib@@ </a>
							</td></tr>
						</xsl:if>
						...
						<xsl:if test="/notification_data/update_port  !=''">
							<tr><td>
							<br /><xsl:value-of select="/notification_data/update_port" /><a>&#160;@@updatePort@@ </a>
							</td></tr>
						</xsl:if>
						<xsl:if test="/notification_data/deleted_port  !=''">
							<tr><td>
							<br /><xsl:value-of select="/notification_data/deleted_port" /><a>&#160;@@deletedPort@@ </a>
							</td></tr>
						</xsl:if>
